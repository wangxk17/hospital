						...
						<div class="search_table">
							<table width="100%">
								...
								<tr>
									...
									<td><input type="text" class="input_common input_short">&nbsp;-&nbsp;<input
										type="text" class="input_common input_short"></td>
								</tr>
								<tr>
									<td class="text_right">状态：</td>
									<td><select class="input_common input_middle">
							...
							<table class="alt" cellpadding="0" cellspacing="0">
								...
								<tbody>
									<tr>
										...
										<td>
											<p class="table_list">
												<label class="table_list_title">医生：</label> <span
													class="table_list_info">王娟</span>
											</p>
											<p class="table_list">
												<label class="table_list_title">科室：</label> <span
													class="table_list_info">内科</span>
											</p>
											<p class="table_list">
												<label class="table_list_title">医馆：</label> <span
													class="table_list_info">健康国医</span>
											</p>
										</td>
										<td class="text_left">
											<p class="table_list">
												<label class="table_list_title">姓名：</label> <span
													class="table_list_info">李丽</span>
											</p>
											<p class="table_list">
												<label class="table_list_title">手机号：</label> <span
													class="table_list_info">18987776890</span>
											</p>
											<p class="table_list">
												<label class="table_list_title">预约描述：</label> <span
													class="table_list_info">描述描述</span>
											</p>
										</td>
										<td>
